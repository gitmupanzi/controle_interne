...
- Proposer dans `Statistiques` un export Word du rapport statistique avec logo, criteres, sources, vue d'ensemble, chiffre d'affaires observe, croissance clients, epargne/DAT, credit et definitions. Le Word reprend exactement le perimetre filtre de l'onglet.
