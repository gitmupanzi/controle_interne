...
/* 17. Ecritures comptables avec date valeur posterieure ou anterieure a la date operation */
SELECT
    ID,
    DATE_OPERATION,
    DATE_VALEUR,
...
/* 20. Rapprochement synthese OPERATIONS vs OPERATIONS_API par NUM_TRANSACTION */
SELECT
