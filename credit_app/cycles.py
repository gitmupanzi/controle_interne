...
CYCLE_ANALYSIS_PRESETS: dict[str, dict[str, Any]] = {
    ...
    "conformite": {
        ...
        "id_columns": ["numero_alerte", "id_declaration", "client_id", "reference_interne"],
        "group_columns": ["type_alerte", "etat_alerte", "statut_couverture", "niveau_risque", "source_declaration"],
        "status_columns": ["etat_alerte", "statut_revue_conformite", "statut_couverture", "severite"],
