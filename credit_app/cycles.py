...
CYCLE_SPECS: dict[str, dict[str, Any]] = {
    ...
    "crm_clients": {
        "label": "Suivi clients CRM",
        "summary": "Suivi de la qualité des fiches clients CRMPlus Zoho, de l'activité récente, de la joignabilité et des informations clés à corriger rapidement.",
        "control_objective": "Accélérer les mises à jour des fiches clients, réduire les informations manquantes et faciliter les actions commerciales et de conformité.",
        "controls": [
            {"Axe": "Identification", "Point de contrôle": "Présence de l'identifiant client, du nom client, de la pièce d'identité et du numéro de compte client."},
            {"Axe": "Joignabilité", "Point de contrôle": "Téléphone, e-mail, province et autres informations utiles au contact rapide du client."},
            {"Axe": "Suivi relationnel", "Point de contrôle": "Dernière activité, verrouillage, désabonnement et statut d'utilisation des canaux."},
            {"Axe": "Pilotage commercial", "Point de contrôle": "Répartition par gestionnaire, origine du prospect, catégorie socio-professionnelle et source de données."},
        ],
        "expected_columns": [
            "client_id",
            "nom_client",
    ...
    "conformite": {
        "label": "Cycle conformité",
        "summary": "Pilotage LBC-FT, traitement des alertes, déclarations de soupçon, profils de risque et sanctions financières ciblées.",
        "control_objective": "Renforcer la surveillance financière, fiabiliser le reporting réglementaire et assurer une piste d'audit complète des décisions de conformité.",
        "controls": [
            {"Axe": "Reporting LBC-FT", "Point de contrôle": "Cohérence des périodes, devises, seuils, volumes et niveaux de couverture transmis au régulateur."},
            {"Axe": "Alertes", "Point de contrôle": "Exhaustivité des alertes générées, justification des traitements, délais de revue et traçabilité des décisions."},
            {"Axe": "Déclarations", "Point de contrôle": "Rapprochement des déclarations de soupçon et CENTIF sans double comptage des formulaires."},
            {"Axe": "Profils de risque", "Point de contrôle": "Identification des clients à haut risque, surveillance renforcée et justification des classements manuels."},
            {"Axe": "Sanctions financières", "Point de contrôle": "Qualité des listes de sanctions et distinction entre screening, correspondance, gel et refus effectif."},
            {"Axe": "Qualité des données", "Point de contrôle": "Présence des références, clients, devises, états et autres champs nécessaires à la piste d'audit."},
        ],
        "expected_columns": [
            "analyse",
            "type_element",
...
CYCLE_ANALYSIS_PRESETS: dict[str, dict[str, Any]] = {
    ...
    "crm_clients": {
        ...
        "id_columns": ["client_id", "compte_id"],
        "group_columns": ["agent_credit", "Origine du Prospect", "zone_geographique", "categorie"],
        "status_columns": ["Mode Désabonné", "Locked", "Rejet des mails"],
        "amount_columns": [],
        "actor_columns": ["agent_credit"],
        "filter_columns": [
            "agent_credit",
    ...
    "conformite": {
        ...
        "id_columns": ["numero_alerte", "reference_interne", "reference_externe", "numero_operation", "code_client", "client_id"],
        "group_columns": ["analyse", "type_element", "rubrique", "etat", "etat_alerte", "statut_couverture", "niveau_risque", "origine_declaration", "source_declaration"],
        "status_columns": ["etat", "etat_alerte", "statut_revue", "statut_revue_conformite", "statut_couverture", "severite"],
