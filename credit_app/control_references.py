...
SQL_OPERATIONS_CONTROL_CATALOG = [
    ...
    {
        "Contrôle ID": 69,
        "Thème": "Octroi et validation",
        "Contrôle": "Prêts décaissés sans validation préalable exploitable",
        "Lecture": "Isole les prêts sans validation, sans validation favorable ou validés trop tard par rapport au déboursement.",
    },
    {
        "Contrôle ID": 70,
        "Thème": "Garanties",
        "Contrôle": "Couverture de garantie insuffisante",
        "Lecture": "Compare la valeur des garanties au niveau attendu par la tranche ou, à défaut, au ratio prudent de couverture.",
    },
    {
        "Contrôle ID": 71,
        "Thème": "Garanties",
        "Contrôle": "Caution financière insuffisante",
        "Lecture": "Rapproche la caution constatée, le taux attendu et le minimum du dossier pour repérer les insuffisances.",
    },
    {
        "Contrôle ID": 72,
        "Thème": "Garanties",
        "Contrôle": "Garanties sans garant correctement documenté",
        "Lecture": "Repère les garanties sans garant exploitable, sans nom clair ou sans pièce de référence.",
    },
    {
        "Contrôle ID": 73,
        "Thème": "Analyse de crédit",
        "Contrôle": "Analyses obligatoires absentes ou inachevées",
        "Lecture": "Vérifie la présence des analyses de revenu et de projet quand la tranche les rend obligatoires.",
    },
    {
        "Contrôle ID": 74,
        "Thème": "Déblocage",
        "Contrôle": "Décaissements sans support exploitable ou incohérents",
        "Lecture": "Rapproche le prêt, le déblocage et l'opération de support pour identifier les cas à revoir en priorité.",
    },
    {
        "Contrôle ID": 75,
        "Thème": "Crédit de groupe",
        "Contrôle": "Crédits de groupe avec nombre de bénéficiaires hors norme",
        "Lecture": "Aide à relire les dossiers collectifs dont la taille de groupe s'écarte de la fourchette recommandée.",
    },
    {
        "Contrôle ID": 76,
        "Thème": "Risque et décision",
        "Contrôle": "Nombre de prêts actifs au-delà de la limite du produit",
        "Lecture": "Compare le cumul de prêts actifs d'un client au maximum paramétré sur le produit.",
    },
    {
        "Contrôle ID": 77,
        "Thème": "Garanties",
        "Contrôle": "Retrait de garantie avant solde du prêt",
        "Lecture": "Signale les garanties retirées alors que le prêt reste non soldé ou soldé plus tard.",
    },
    {
        "Contrôle ID": 78,
        "Thème": "Rééchelonnement",
        "Contrôle": "Demandes de rééchelonnement sans validation exploitable",
        "Lecture": "Isole les rééchelonnements non validés ou saisis sur des prêts déjà sortis du portefeuille normal.",
    },
    {
        "Contrôle ID": 79,
        "Thème": "Rééchelonnement",
        "Contrôle": "Prêts marqués rééchelonnés sans demande formelle",
        "Lecture": "Repère les prêts dont la date de rééchelonnement existe sans dossier formalisé correspondant.",
    },
    {
        "Contrôle ID": 80,
        "Thème": "Contentieux",
        "Contrôle": "Prêts en contentieux avec incohérences de transfert ou de montant",
        "Lecture": "Contrôle la cohérence des dates et des montants pour les dossiers basculés en contentieux.",
    },
    {
        "Contrôle ID": 81,
        "Thème": "Octroi et validation",
        "Contrôle": "Validations de dossier incohérentes avec le dossier ou le prêt",
        "Lecture": "Compare le montant, les échéances, le différé et la grâce validés aux valeurs du dossier et du prêt.",
    },
    {
        "Contrôle ID": 82,
        "Thème": "Garanties",
        "Contrôle": "Types de garantie utilisés mais non paramétrés pour l'agence",
        "Lecture": "Signale les garanties hors paramétrage du point de service ou de la devise concernée.",
    },
    {
        "Contrôle ID": 83,
        "Thème": "Suivi du prêt",
        "Contrôle": "Cycles de prêt sans échéancier TABAMOR exploitable",
        "Lecture": "Repère les cycles sans plan d'amortissement lisible pour le suivi des échéances et de la piste d'audit.",
    },
    {
        "Contrôle ID": 84,
        "Thème": "Risque de portefeuille",
        "Contrôle": "Taux d'impayé du portefeuille par tranche de montant et par devise",
        "Lecture": "Mesure, par tranche de montant et par devise, la part des cycles échus non clôturés par rapport aux montants octroyés sur la période.",
    },
    {
        "Contrôle ID": 85,
        "Thème": "Fidélisation et clôture",
        "Contrôle": "Clients qui terminent leur crédit par mois, devise et agence",
        "Lecture": "Suit les clients dont les prêts sont soldés afin de lire les clôtures mensuelles et les opportunités de renouvellement par devise ou par agence.",
    },
    {
        "Contrôle ID": 86,
        "Thème": "Fidélisation et renouvellement",
        "Contrôle": "Synthèse de renouvellement après clôture",
        "Lecture": "Mesure, par mois, devise et agence, la part des clients soldés qui reviennent ensuite sur un nouveau prêt.",
    },
    {
        "Contrôle ID": 87,
        "Thème": "Fidélisation et délai de retour",
        "Contrôle": "Délai de renouvellement après clôture",
        "Lecture": "Classe les retours après solde en renouvellement rapide, moyen, tardif ou pas encore renouvelé pour mieux lire le rythme de fidélisation.",
    },
    {
        "Contrôle ID": 88,
        "Thème": "Fidélisation et mobilité agence",
        "Contrôle": "Renouvellement dans la même agence ou avec changement d'agence",
        "Lecture": "Compare l'agence du prêt soldé et celle du premier prêt repris pour distinguer les retours fidèles à l'agence et les renouvellements avec mobilité.",
    },
    {
        "Contrôle ID": 89,
        "Thème": "Fidélisation et évolution du montant",
        "Contrôle": "Evolution du montant au renouvellement",
        "Lecture": "Compare le montant du prêt soldé et celui du premier prêt repris pour distinguer les renouvellements en hausse, en baisse, stables ou pas encore renouvelés.",
    },
]
