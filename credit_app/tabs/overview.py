...
GENERIC_OVERVIEW_CONFIG = {
    "conformite": {
        ...
        "primary_columns": ["rubrique", "statut_couverture", "source_declaration"],
        ...
        "group_columns": ["statut_couverture", "rubrique", "source_declaration"],
        ...
        "balance_columns": [],
        "alert_columns": ["anomalie_adherent_introuvable", "anomalie_identite_absente"],
