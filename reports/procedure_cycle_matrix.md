...
| Money Provider / M-PESA | monnaie électronique, E-money, dépôts/retraits, vérification, documentation, écarts, confidentialité | rapprochement G2/DAT, devise, téléphone normalisé, solde reconstitué, écarts, traçabilité et LBC/FT | `Procédure de MONEY PROVIDER-IMB BISOU BISOU.pdf`, fichiers M-PESA/Turbo décrits dans le README |
